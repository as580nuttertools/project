		...
		<tr>
			<td colspan="5"><b>เลขที่ใบสั่งซื้อ : </b><%=rs.getString("order_id")%><br>
				<b>ชื่อ: </b><%=new String(rs.getString("fname")
						...
						.getBytes("ISO8859_1"), "windows-874")%><br> <b>วันที่สั่งซื้อ : </b><%=dateTH(rs.getString("date"))%>
				<br></td>
		</tr>
		<tr bgcolor="#79CDCD">
		...
		<tr>
			<td colspan="5"><div align="center">
					<input name="print_detail" type="button"
						onClick="MM_openBrWindow('print_order.jsp?order_id=<%=order_id%>','','width=650,height=350')"
