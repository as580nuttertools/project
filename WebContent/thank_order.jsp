	...
	cellspacing="0" bgcolor="#E1EEEE" border="1">
		...
		<tr>
			<td colspan="5"><b>เลขที่ใบสั่งซื้อ :</b> <%=rs.getString("order_id")%><br>
				<b>ผู้ซื้อ: </b> <%=session.getAttribute("j_fname")%> <%=session.getAttribute("j_lname")%><br>
		...
		<tr>
			...
			<td align="center"><%=total%> บาท</td>
		</tr>
		<tr>
			<td colspan="5"><div align="center">
					<input name="print_detail" type="button"
						onClick="MM_openBrWindow('print_order_detail_out.jsp?order_id=<%=order_id%>','','width=650,height=700')"
